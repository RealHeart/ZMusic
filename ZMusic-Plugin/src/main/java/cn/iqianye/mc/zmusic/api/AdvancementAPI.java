...
public class AdvancementAPI {
    ...
    public void loadAdvancement_1_12_R1(NamespacedKey key, String json) {
        if (Bukkit.getAdvancement(key) != null)
            return;
        net.minecraft.server.v1_12_R1.Advancement.SerializedAdvancement serializedAdvancement = net.minecraft.server.v1_12_R1.ChatDeserializer.a(net.minecraft.server.v1_12_R1.AdvancementDataWorld.DESERIALIZER, json, net.minecraft.server.v1_12_R1.Advancement.SerializedAdvancement.class);
    ...
    public void removeAdvancement_1_12_R1(Advancement advancement) {
        ...
        for (Map.Entry<net.minecraft.server.v1_12_R1.MinecraftKey, net.minecraft.server.v1_12_R1.Advancement> entry : net.minecraft.server.v1_12_R1.AdvancementDataWorld.REGISTRY.advancements.entrySet()) {
    ...
    public void loadadvancement_1_13_R2(NamespacedKey key, String json) {
        if (Bukkit.getAdvancement(key) != null)
            return;
        net.minecraft.server.v1_13_R2.Advancement.SerializedAdvancement serializedAdvancement = net.minecraft.server.v1_13_R2.ChatDeserializer.a(net.minecraft.server.v1_13_R2.AdvancementDataWorld.DESERIALIZER, json, net.minecraft.server.v1_13_R2.Advancement.SerializedAdvancement.class);
        if (serializedAdvancement != null)
    ...
    public void removeAdvancement_1_13_R2(Advancement advancement) {
        Bukkit.getUnsafe().removeAdvancement(id);
        for (Map.Entry<net.minecraft.server.v1_13_R2.MinecraftKey, net.minecraft.server.v1_13_R2.Advancement> entry : net.minecraft.server.v1_13_R2.AdvancementDataWorld.REGISTRY.advancements.entrySet()) {
            if ((entry.getValue()).getName().getKey().equals(advancement.getKey().getKey().toLowerCase())) {
                net.minecraft.server.v1_12_R1.AdvancementDataWorld.REGISTRY.advancements.remove(entry.getKey());
                break;
            }
    ...
    public void loadAdvancement_1_14_R1(NamespacedKey key, String json) {
        if (Bukkit.getAdvancement(key) != null)
            return;
        net.minecraft.server.v1_14_R1.Advancement.SerializedAdvancement serializedAdvancement = net.minecraft.server.v1_14_R1.ChatDeserializer.a(net.minecraft.server.v1_14_R1.AdvancementDataWorld.DESERIALIZER, json, net.minecraft.server.v1_14_R1.Advancement.SerializedAdvancement.class);
        if (serializedAdvancement != null)
            try {
    ...
    public void removeAdvancement_1_14_R1(Advancement advancement) {
        ...
        try {
            net.minecraft.server.v1_14_R1.DedicatedServer dedicatedServer = ((org.bukkit.craftbukkit.v1_14_R1.CraftServer) Bukkit.getServer()).getServer();
            net.minecraft.server.v1_14_R1.Advancements advancements = (dedicatedServer.getAdvancementData()).REGISTRY;
            for (Map.Entry<net.minecraft.server.v1_14_R1.MinecraftKey, net.minecraft.server.v1_14_R1.Advancement> entry : advancements.advancements.entrySet()) {
                if ((entry.getValue()).getName().getKey().equals(advancement.getKey().getKey().toLowerCase())) {
    ...
    public void removeAdvancement_1_15_R1(Advancement advancement) {
        ...
        try {
            net.minecraft.server.v1_15_R1.DedicatedServer dedicatedServer = ((org.bukkit.craftbukkit.v1_15_R1.CraftServer) Bukkit.getServer()).getServer();
            net.minecraft.server.v1_15_R1.Advancements advancements = (dedicatedServer.getAdvancementData()).REGISTRY;
            for (Map.Entry<net.minecraft.server.v1_15_R1.MinecraftKey, net.minecraft.server.v1_15_R1.Advancement> entry : advancements.advancements.entrySet()) {
                if ((entry.getValue()).getName().getKey().equals(advancement.getKey().getKey().toLowerCase())) {
                    advancements.advancements.remove(entry.getKey());
                    break;
                }
    ...
    public void removeAdvancement_1_16_R1(Advancement advancement) {
        ...
        try {
            ...
            for (Map.Entry<net.minecraft.server.v1_16_R1.MinecraftKey, net.minecraft.server.v1_16_R1.Advancement> entry : advancements.advancements.entrySet()) {
                if ((entry.getValue()).getName().equals(advancement.getKey().getKey().toLowerCase()))
                    ;
                advancements.advancements.remove(entry.getKey());
                break;
            }
    ...
    public void removeAdvancement_1_16_R2(Advancement advancement) {
        ...
        try {
            ...
            for (Map.Entry<net.minecraft.server.v1_16_R2.MinecraftKey, net.minecraft.server.v1_16_R2.Advancement> entry : advancements.advancements.entrySet()) {
                if ((entry.getValue()).getName().equals(advancement.getKey().getKey().toLowerCase()))
                    ;
                advancements.advancements.remove(entry.getKey());
                break;
    ...
    public void removeAdvancement_1_16_R3(Advancement advancement) {
        ...
        try {
            ...
            for (Map.Entry<net.minecraft.server.v1_16_R3.MinecraftKey, net.minecraft.server.v1_16_R3.Advancement> entry : advancements.advancements.entrySet()) {
                if ((entry.getValue()).getName().getKey().equals(advancement.getKey().getKey().toLowerCase())) {
                    advancements.advancements.remove(entry.getKey());
                    break;
                }
    ...
    public void loadAdvancement_1_17_R1(NamespacedKey key, String json) throws NoSuchFieldException, NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        SerializedAdvancement serializedAdvancement = (SerializedAdvancement) SerializedAdvancement.class
                .getDeclaredMethod("a", JsonObject.class, LootDeserializationContext.class)
                .invoke(SerializedAdvancement.class, jsonObject, new LootDeserializationContext(minecraftKey, MinecraftServer.getServer().getLootPredicateManager()));
    ...
    public void loadAdvancement_1_18_R1(NamespacedKey key, String json) throws NoSuchFieldException, NoSuchMethodException, InvocationTargetException, IllegalAccessException, ClassNotFoundException {
        ...
        SerializedAdvancement serializedAdvancement = (SerializedAdvancement) SerializedAdvancement.class
                .getDeclaredMethod("a", JsonObject.class, LootDeserializationContext.class)
                .invoke(SerializedAdvancement.class,
                        jsonObject,
