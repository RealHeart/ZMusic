...
public class NetUtils {
    ...
    public static String getNetStringBiliBili(String url, String Referer) {
        try {
            String ua = "ZMusic/" + Val.thisVer + " (service@iqianye.cn)";
    ...
    public static String getNetString(String url, String Referer) {
        try {
            String ua = "Mozilla/5.0 (Linux; Android 11; Mi 10) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.99 Mobile Safari/537.36 ZMusic/" + Val.thisVer;
            return getString(url, Referer, ua);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
