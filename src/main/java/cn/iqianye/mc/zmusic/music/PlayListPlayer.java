            ...
            if (ZMusic.player.isOnline(player)) {
                ...
                if (singleIsPlayEd) {
                    ...
                    if (platform.equalsIgnoreCase("qq")) {
                        ...
                        String getMp3Url = Conf.qqMusicApiRoot + "song/url?id=" + id + "&mediaId=" + mid;
                        ...
                        String getLyricUrl = Conf.qqMusicApiRoot + "lyric?songmid=" + id;
                        ...
                        String id = playList.get(songs).get("id").getAsString();
                        String getMp3Url = Conf.neteaseApiRoot + "song/url?id=" + id + "&br=320000";
                        String getMp3JsonText = NetUtils.getNetString(getMp3Url, null);
                        JsonObject getMp3Json = gson.fromJson(getMp3JsonText, JsonObject.class);
                        try {
                        ...
                        String lyricJsonText = NetUtils.getNetString(Conf.neteaseApiRoot + "lyric?id=" + id, null);
                        JsonObject lyricJson = gson.fromJson(lyricJsonText, JsonObject.class);
                        String lyricText = "";
                        String lyricTrText = "";
                        try {
                    ...
                    TextComponent message = new TextComponent(Conf.prefix + "§a播放§r[§e" + fullName + "§r]§a成功,耗时" + successTime + "毫秒!");
                    ...
                    if (Conf.realSupportAdvancement) {
                        ZMusic.runTask.start(new Runnable() {
                            @Override
                            public void run() {
                                new AdvancementAPI("§a正在播放\n§e" + fullName).sendAdvancement(player);
                            }
                        });
                    }
                    songs++;
