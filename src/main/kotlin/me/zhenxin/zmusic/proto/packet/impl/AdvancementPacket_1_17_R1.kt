...
class AdvancementPacket_1_17_R1(
    ...
    override fun sent(add: Boolean) {
        ...
        if (add) {
            ...
            val criterionProgress: CriterionProgress = advancementProgress
                .javaClass
                .getDeclaredMethod("getCriterionProgress", String::class.java)
                .invoke(advancementProgress, "1") as CriterionProgress
            criterionProgress.b()
