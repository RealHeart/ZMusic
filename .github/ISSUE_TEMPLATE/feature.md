...
- [ ] 确保您的功能请求尚未在 [Issues](https://github.com/starhui-dev/zmusic-plugin/issues) 列表中提出.
...
当然，如果您有兴趣，也可以自己实现并向我们提交 [Pull Request](https://github.com/starhui-dev/zmusic-plugin/pulls)。