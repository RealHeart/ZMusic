        ...
        switch (type) {
            ...
            case "playlist":
                ...
                if (isAdmin) {
                    ...
                    ZMusic.message.sendNormalMessage("/zm playlist global [163/netease] list - 查看已导入的全服歌单列表§a.", playerObj);
                    ZMusic.message.sendNormalMessage("/zm playlist global [163/netease] play <歌单ID> - 播放已导入的全服歌单§a.", playerObj);
