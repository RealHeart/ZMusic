...
import me.zhenxin.zmusic.dependencies.classloader.IsolatedClassLoader;
 ...
 */
@SuppressWarnings({"AlibabaUndefineMagicConstant", "CallToPrintStackTrace", "AlibabaLowerCamelCaseVariableNaming"})
public class ClassAppender {
    ...
    public static boolean isExists(String path) {
        try {
            Class.forName(path, false, ZMusicRuntime.class.getClassLoader());
            return true;
