...
public class Toast {
    ...
    public static void sendToast(Object player, String title) {
        String packageName = Addon.plugin.getServer().getClass().getPackage().getName();
        ...
        switch (nms) {
            ...
            case "v1_12_R1":
                ...
                break;
            default:
                Addon.plugin.getLogger().warning(ChatColor.RED + "不支持的NMS版本: " + nms);
                return;
        }
